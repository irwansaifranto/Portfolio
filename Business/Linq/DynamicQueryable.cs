...
#pragma warning restore 0219
        ...
        private Expression ParseComparison()
        {
                   ...
                   token.id == TokenId.LessThan || token.id == TokenId.LessThanEqual)
            {
                ...
                if (isEquality && !left.Type.IsValueType && !right.Type.IsValueType ||
                    ...
                    (
                        (left.Type == typeof(Guid) || left.Type == typeof(Nullable<Guid>)) &&
                        (right.Type == typeof(Guid) || right.Type == typeof(Nullable<Guid>))
                    ) ||
                    (
                                             ...
                                             int errorPos)
        {
            ...
            //if (left.GetType() == typeof(Nullable<Guid>))
            //{
            //    args = new[] { left, new Nullable<Guid>(right) };
            //}
